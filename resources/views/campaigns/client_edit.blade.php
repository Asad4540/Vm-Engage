...
@section('content')
    <div id="report-section">
                        ...
                        <div class="m-2 mb-3 text-center ">
                            <div>
                                ...
                                @if($campaign->client->logo)
                                    <div class="mt-2">
                                        <img src="{{ asset('images/client_logos/' . $campaign->client->logo) }}"
                                            alt="Ad Preview" width="300" height="auto">
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="m-2">
                            ...
                            <div class="circle-chart mx-auto my-4">
                                ...
                                <div class="percentage" name="remaining" id="remaining"
                                    value="{{ old('remaining', $campaign->remaining ?? '') }}">{{ round($remaining) }}%
                                </div>
                            </div>
        ...
        <footer class="d-flex justify-content-center mt-5">
            <h5>VM Engage | Copyright © 2025 <b><a href="https://vereigenmedia.com/" target="_blank"
                        style="color:#000; text-decoration: none; ">Vereigen Media</b></a></h5>
        </footer>
    </div>
@endsection
    ...
    <script>
        ...
        document.getElementById('downloadPdfBtn').addEventListener('click', function () {
            ...
            html2canvas(section, { scale: 2 }).then(canvas => {
                ...
                // Full image height in mm (scaled to PDF width)
                ...
                // Add first page
                pdf.addImage(imgData, 'PNG', 0, position, pdfWidth, fullImgHeight);
                ...
                const scaleY = fullImgHeight / canvas.height;
                ...
                section.querySelectorAll('a').forEach(a => {
                    ...
                    if (a.href) {
                        ...
                        if (pageIndex > 0) {
                            while (pdf.internal.getNumberOfPages() <= pageIndex) {
                                pdf.addPage();
                            }
